...
#   llamagen: https://github.com/FoundationVision/LlamaGen/tree/main/tokenizer/vqgan
...
class VQModelLlamaGen(nn.Module):
...
#################################################################################
def VQ_8(**kwargs):
    return VQModelLlamaGen(ModelArgs(encoder_ch_mult=[1, 2, 2, 4], decoder_ch_mult=[1, 2, 2, 4], **kwargs))


def VQ_16(**kwargs):
    return VQModelLlamaGen(ModelArgs(encoder_ch_mult=[1, 1, 2, 2, 4], decoder_ch_mult=[1, 1, 2, 2, 4], **kwargs))

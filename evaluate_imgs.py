...
CONFIG_PATH = "/mnt/bn/vgfm2/test_dit/geneval/mmdetection/mmdet/../configs/mask2former/mask2former_swin-s-p4-w7-224_lsj_8x2_50e_coco.py"
OBJECT_DETECTOR = "mask2former_swin-s-p4-w7-224_lsj_8x2_50e_coco"
CKPT_PATH = os.path.join("/mnt/bn/vgfm2/test_dit/geneval/weights", f"{OBJECT_DETECTOR}.pth")
object_detector = init_detector(CONFIG_PATH, CKPT_PATH, device="cuda")

clip_arch = "ViT-L-14"
clip_model, _, transform = open_clip.create_model_and_transforms(clip_arch, pretrained="openai", device="cuda")
tokenizer = open_clip.get_tokenizer(clip_arch)

with open("/mnt/bn/vgfm2/test_dit/geneval/evaluation/object_names.txt") as cls_file:
...
def evaluate_image_training(filepath, metadata, device):
    ...
    # import pdb; pdb.set_trace()
    # image = ImageOps.exif_transpose(Image.fromarray(filepath))
    detected = {}

...
if __name__ == '__main__':
    ...
    with open("./validation_prompts/evaluation_metadata_qa.jsonl") as  f:
    ...
    for step in tqdm(range(0, len(validation_prompts))):
        ...
        for sample_count in range(4):
            ...
            if is_correct:
                ...
                image_result['answer'] = text
                image_result['image_path'] = os.path.join(sample_path, f"{sample_count:05}.png")
                image_result['prompts'] = prompts[0]
                total_num +=1
                print(result)

                if result.lower() == "same":
                    correct_num+=1
                    image_result['correct'] = True

                else:
                    print("t2i succeed, mmu fail")
                    image_result['correct'] = False
                    total_reward+=1
                    first_step+=1
